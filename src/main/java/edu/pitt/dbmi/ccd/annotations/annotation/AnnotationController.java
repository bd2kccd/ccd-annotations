 ...
 * MA 02110-1301  USA
 */
package edu.pitt.dbmi.ccd.annotations.annotation;
...
import edu.pitt.dbmi.ccd.annotations.error.AccessUpdateException;
import edu.pitt.dbmi.ccd.annotations.error.AnnotationDataNotFoundException;
import edu.pitt.dbmi.ccd.annotations.error.AnnotationNotFoundException;
import edu.pitt.dbmi.ccd.annotations.error.AnnotationTargetNotFoundException;
import edu.pitt.dbmi.ccd.annotations.error.AttributeNotFoundException;
...
import edu.pitt.dbmi.ccd.annotations.error.VocabularyNotFoundException;
...
public class AnnotationController {
    ...
    public AnnotationResource newAnnotation(@AuthenticationPrincipal UserAccountDetails principal, @RequestBody @Valid AnnotationForm form) throws NotFoundException {
        ...
        // get vocabulary
        final Vocabulary vocabulary = vocabularyService.findByName(form.getVocabulary());
        if (vocabulary == null) {

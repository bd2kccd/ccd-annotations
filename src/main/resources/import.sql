...
-- Create Vocabularies
INSERT INTO vocabulary (id, description, name, version, created, modified) VALUES (1, 'Text with no required structure', 'Plaintext', 0, CURRENT_DATE, NULL), (2, 'Health Care and Life Sciences (https://www.w3.org/wiki/HCLS)', 'HCLS', 0, CURRENT_DATE, NULL);
...
INSERT INTO annotation (id, redacted, version, access_control, parent_id, upload_id, user_account_id, vocab_id) VALUES (5, b'0', 0, 3, NULL, 1, 1, 1);
INSERT INTO annotation_data (id, value, annotation_id, attribute_id) VALUES (5, 'Private annotation', 6, 1), (7, 'Private annotation with additional data', 6, 1);

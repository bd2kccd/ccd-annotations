 ...
 * MA 02110-1301  USA
 */
package edu.pitt.dbmi.ccd.annotations;
...
@SpringBootTest
@WebAppConfiguration
public class CCDAnnotationsTest {
    ...
    public void errorExample() throws Exception {
        this.mockMvc
                ...
                .andExpect(jsonPath("exception", is("Not Found")))
                ...
                .andDo(this.documentationResultHandler.document(
                        ...
                        responseFields(
                                fieldWithPath("timestamp").description("The time at which the exception occurred"),
                                fieldWithPath("status").description("The HTTP status code"),
                                fieldWithPath("exception").description("The HTTP exception"),
                                fieldWithPath("message").description("A description of what caused the exception"),
